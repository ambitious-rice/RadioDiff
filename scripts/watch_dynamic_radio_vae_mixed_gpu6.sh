...
CFG=./configs/first_dynamic_radio_mixed_50_50.yaml
SESSION_LOG="$ROOT_DIR/logs/watch_dynamic_radio_vae_mixed_gpu6.log"
...
while true; do
  ...
  run_log="$ROOT_DIR/logs/train_dynamic_radio_vae_mixed_gpu6_run_${run_id}.log"
